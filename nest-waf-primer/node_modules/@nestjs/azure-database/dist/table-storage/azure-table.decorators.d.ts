...
export declare function EntityPartitionKey(value: ValueType): (target: object, propertyKey?: string) => void;
export declare function EntityRowKey(value: ValueType): (target: object, propertyKey?: string) => void;
